...
#import <MMSmartStreamingSDK/M3U8MasterPlaylist.h>
#import <MMSmartStreamingSDK/M3U8MediaPlaylist.h>
...
@interface MMM3U8PlaylistModel : NSObject
...
@property (readonly, nonatomic, strong) MMM3U8MediaPlaylist *mainMediaPl;
- (void)changeMainMediaPlWithPlaylist:(MMM3U8MediaPlaylist *)playlist;
@property (readonly, nonatomic, strong) MMM3U8MediaPlaylist *audioPl;
...
- (NSString *)prefixOfSegmentNameInPlaylist:(MMM3U8MediaPlaylist *)playlist;
- (NSString *)sufixOfSegmentNameInPlaylist:(MMM3U8MediaPlaylist *)playlist;

- (NSArray *)segmentNamesForPlaylist:(MMM3U8MediaPlaylist *)playlist;
