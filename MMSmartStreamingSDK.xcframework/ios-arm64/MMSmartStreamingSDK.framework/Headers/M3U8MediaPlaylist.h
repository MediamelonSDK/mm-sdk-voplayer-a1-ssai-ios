...
#import <MMSmartStreamingSDK/M3U8SegmentInfoList.h>
...
@interface MMM3U8MediaPlaylist : NSObject
...
@property (readonly, nonatomic, strong) MMM3U8SegmentInfoList *segmentList;
